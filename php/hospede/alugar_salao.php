...
<body>
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1><i class="fas fa-glass-cheers me-2"></i>Alugar Salão de Festa</h1>
        ...
        <!-- Passo 1: Lista de salões disponíveis -->
        <div class="row mb-5">
            <h3 class="mb-4"><i class="far fa-calendar-check me-2"></i>Salões Disponíveis</h3>
            
            <?php if (!empty($saloes)): ?>
                <?php foreach ($saloes as $salao): ?>
                    <div class="col-md-6 col-lg-4">
                        <div class="card card-salao">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    <i class="fas fa-users me-2"></i>Capacidade: <?= $salao['capacidade'] ?> pessoas<br>
                                    <i class="fas fa-money-bill-wave me-2"></i>R$ <?= number_format($salao['preco'], 2, ',', '.') ?> / dia
                                </p>
                    ...
                    <div class="modal fade" id="detalhesModal<?= $salao['id_salao'] ?>" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-lg modal-detalhes">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <img src="img/saloes/<?= $salao['id_salao'] ?>.jpg" class="img-fluid rounded mx-auto d-block" alt="<?= htmlspecialchars($salao['nome']) ?>">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p><strong><i class="fas fa-users me-2"></i>Capacidade:</strong> <?= $salao['capacidade'] ?> pessoas</p>
                                            <p><strong><i class="fas fa-ruler-combined me-2"></i>Tamanho:</strong> 150 m²</p>
                                            <p><strong><i class="fas fa-money-bill-wave me-2"></i>Preço:</strong> R$ <?= number_format($salao['preco'], 2, ',', '.') ?> / dia</p>
                                        </div>
                                        <div class="col-md-6">
                                            <p><strong><i class="fas fa-star me-2"></i>Características:</strong></p>
                                            <ul>
                                                <li>Palco integrado</li>
                                    ...
                                    <div class="mt-3">
                                        <h5><i class="fas fa-user-tie me-2"></i>Responsáveis:</h5>
                                        <p>Carlos Silva - (11) 98765-4321<br>
                                        Maria Oliveira - (11) 91234-5678</p>
                                    </div>
                                </div>
        ...
        <!-- Passo 2: Lista de decorações disponíveis -->
        <div class="row">
            <h3 class="mb-4"><i class="fas fa-palette me-2"></i>Temas de Decoração</h3>
                    ...
                    <div class="modal fade" id="detalhesDecoracao<?= $decoracao['id_decoracao'] ?>" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <img src="img/decoracoes/<?= $decoracao['id_decoracao'] ?>.jpg" class="img-fluid rounded mb-3" alt="<?= htmlspecialchars($decoracao['nome']) ?>">
                                    <p><?= htmlspecialchars($decoracao['descricao']) ?></p>
                                    <p><strong>Preço:</strong> R$ <?= number_format($decoracao['preco'], 2, ',', '.') ?></p>
                                    <p><strong>Inclui:</strong></p>
                                    <ul>
                                        <li>Decoração completa do ambiente</li>
                                        <li>Mesa de doces temática</li>
                                        <li>Arranjos de mesa personalizados</li>
