...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result_check->num_rows > 0) {
        ...
        $sql = "INSERT INTO hospede (horario, nome, telefone, endereço, email, RG, CPF, login, senha, confirm_senha) 
                VALUES ('$dataHoraAtual', '$nome', '$telefone', '$endereco', '$email', '$RG', '$CPF', '$login', '$hashed_password', '$confirm_password)";
...
<body>
    ...
    <form action="register_hospede.php" method="POST">
        <div class="form-container">
            ...
            <input type="password" id="confirm_password" name="confirmar senha" required>
        </div>
