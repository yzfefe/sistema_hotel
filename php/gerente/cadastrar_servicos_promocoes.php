...
<div class="container py-5">
            ...
            <form method="post" class="row g-3">
                <div class="col-md-9">
                    <input type="text" name="search" class="form-control form-control-lg" 
                           placeholder="Digite o ID ou Nome do serviço" required>
                </div>
                <div class="col-md-3">
    ...
    <?php elseif (isset($result)): ?>
        <div class="alert alert-warning text-center">
            <i class="bi bi-exclamation-triangle"></i> Nenhum serviço encontrado.
        </div>
    <?php endif; ?>

    <div class="text-center">
        <a href="http://localhost/sistema_hotel-main/html/gerente/tela_gerente.html" 
