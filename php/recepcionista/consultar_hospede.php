...
<body>
    <div class="container">
        ...
        <h1><i class="bi bi-people-fill"></i> Consulta de Hóspedes</h1>
            ...
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?= htmlspecialchars($hospede['id_hos']) ?></td>
                            ...
                            <td>
                                <span class="badge rounded-pill">
                                    Atuais: R$ <?= number_format($hospede['gastos_atuais'], 2, ',', '.') ?>
                                </span>
                                <span class="badge rounded-pill">
                                    Totais: R$ <?= number_format($hospede['gastos_totais'], 2, ',', '.') ?>
                                </span>
                            </td>
                        </tr>
                        <?php endwhile; ?>
        ...
        <?php else: ?>
            <div class="no-results">
                <i class="bi bi-exclamation-circle"></i> Nenhum hóspede encontrado.
            </div>
        <?php endif; ?>
    </div>
