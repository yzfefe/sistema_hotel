                        ...
                        <?php foreach ($reservas as $reserva): ?>
                            <div class="card card-reserva">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <p><i class="bi bi-calendar-check text-primary"></i> <strong>Data Início:</strong> <?= date('d/m/Y', strtotime($reserva['data_criacao'])) ?></p>
                                            <p><i class="bi bi-calendar-x text-primary"></i> <strong>Data Fim:</strong> <?= date('d/m/Y', strtotime($reserva['data_fim'])) ?></p>
                                        </div>
                                        <div class="col-md-4">
