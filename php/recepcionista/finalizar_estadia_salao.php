...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['gerar_conta'])) {
        ...
        $sql_reserva = "SELECT data_inicio, data_fim, id_salao, valor_total FROM reservas_salao WHERE id_reserva = ?";
                        ...
                        <?php foreach ($reservas as $reserva): ?>
                            <div class="card card-reserva">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <p><i class="bi bi-calendar-check text-primary"></i> <strong>Data Início:</strong> <?= date('d/m/Y H:i', strtotime($reserva['data_inicio'])) ?></p>
                                            <p><i class="bi bi-calendar-x text-primary"></i> <strong>Data Fim:</strong> <?= date('d/m/Y H:i', strtotime($reserva['data_fim'])) ?></p>
                                        </div>
                                        <div class="col-md-4">
                                            <p><i class="bi bi-clock text-primary"></i> <strong>Horas reservadas:</strong> <?= date_diff(new DateTime($reserva['data_inicio']), new DateTime($reserva['data_fim']))->h ?></p>
                                        </div>
                                        <div class="col-md-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <ul class="list-group">
                                <li class="list-group-item d-flex justify-content-between">
                                    ...
                                    <span><?= date('d/m/Y H:i', strtotime($conta_gerada['data_inicio'])) ?> a <?= date('d/m/Y H:i', strtotime($conta_gerada['data_fim'])) ?></span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between">
                                    <span><i class="bi bi-clock text-primary"></i> Horas de Uso:</span>
                                    <span><?= $conta_gerada['horas'] ?></span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between">
                                    <span><i class="bi bi-cash-coin text-primary"></i> Valor por Hora:</span>
                                    <span>R$ <?= number_format($conta_gerada['preco_hora'], 2, ',', '.') ?></span>
                                </li>
